...
model = pk.load(open(r"C:\Users\Saurabh Maurya\Documents\PROJECT OF ML\House_prediction_model.pkl", "rb"))
...
if st.button("Predict Price"):
    ...
    price = prediction[0] # ye list ya array se simple data banata hai like  [ 23434] - 23434
    st.success(f"House Price:₹{int(price)}") 
